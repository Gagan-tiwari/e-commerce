  ...
  return (
    <nav className="navbar">
      <div className="container mx-auto flex items-center justify-between py-4 px-4 lg:px-8 ">
        ...
        {/* Search Bar */}
        <div
          className={`hidden lg:flex items-center border border-gray-300 rounded-md overflow-hidden w-full sm:w-auto ${
          ...
          {[
            ...
            <div key={title} className="relative ">
              <button
                ...
                className="flex justify-between items-center w-full text-left p-2 text-gray-700 "
              >
                {title}
